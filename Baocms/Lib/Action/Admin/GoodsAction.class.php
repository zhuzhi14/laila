...
class GoodsAction extends CommonAction {
    ...
    private $create_fields = array('title', 'shop_id', 'photo', 'cate_id', 'price', 'mall_price','settlement_price','use_integral','mobile_fan', 'commission', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby','ltme','rush_ltime','rush_kucun','rush_price','max_buy','attr','kucun');
    private $edit_fields = array('title', 'shop_id', 'photo', 'cate_id', 'price', 'mall_price','settlement_price','use_integral','mobile_fan', 'commission', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby','ltme','rush_ltime','rush_kucun','rush_price','max_buy','attr','kucun');
    ...
    private function createCheck() {
        ...
        //2016年10月26日 13:09:20  添加库存 zhuzhiliang
...
//库存不能为空 2016年10月26日 13:21:20  zhuzhiliang
        $data['kucun']=(int)$data['kucun'];
        if(empty($data['kucun'])){
