...
class RelayAction extends CommonAction {
	private $create_fields = array('help_id','owner_maxgold','shop_id','keyword','title','intro','photo','relay_num','stime','ltime','time','use_tips','end_tips','predict_num','max_gold','min_gold','max_num','follower_condtion','member_condtion','collect_count','views','end_photo','clientip','dateline');
	private $edit_fields = array('help_id','owner_maxgold','shop_id','keyword','title','intro','photo','relay_num','stime','ltime','time','use_tips','end_tips','predict_num','max_gold','min_gold','max_num','follower_condtion','member_condtion','collect_count','views','end_photo','clientip','dateline');
