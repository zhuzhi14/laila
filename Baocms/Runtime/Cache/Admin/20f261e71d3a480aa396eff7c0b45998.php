...
<div class="main-jsgl main-sc">
    ...
    <form  target="baocms_frm" method="post">
        <div class="tableBox">
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                    ...
                    <td><?php if(($var["closed"]) == "1"): ?><span style="color: red;">已关闭</span><?php else: ?><span style="color:green;">正常</span><?php endif; ?></td>
                    <td>
                    ...
                    <?php if(($var["closed"]) == "1"): echo BA('shop/open',array("shop_id"=>$var["shop_id"]),'开启','act','remberBtn'); else: echo BA('shop/delete',array("shop_id"=>$var["shop_id"]),'关闭','act','remberBtn'); endif; ?>
        ...
        <div class="selectNr" style="margin-bottom: 0px; border-bottom: none;">
            <div class="left">
                <?php echo BA('shop/open','','批量开启','list',' list');?>
                <?php echo BA('shop/delete','','批量关闭','list',' a2');?>
            </div>
        </div>
    </form>
</div>
