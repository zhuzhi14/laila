        ...
        <form target="baocms_frm" action="<?php echo U('goods/create');?>" method="post">
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"
                    ...
                    <td class="rgTdBt">
                        ...
                        <select id="cate_id" name="data[cate_id]" class="manageSelect w100">
                            <?php if(is_array($cates)): foreach($cates as $key=>$var): if(($var["parent_id"]) == "0"): ?><option value="<?php echo ($var["cate_id"]); ?>"
                                    <?php if(($var["cate_id"]) == $detail["cate_id"]): ?>selected="selected"<?php endif; ?>
                                    ><?php echo ($var["cate_name"]); ?>(<?php echo ($var["rate"]); ?>‰)</option>
                                    <?php if(is_array($cates)): foreach($cates as $key=>$var2): if(($var2["parent_id"]) == $var["cate_id"]): ?><option value="<?php echo ($var2["cate_id"]); ?>"
                                            <?php if(($var2["cate_id"]) == $detail["cate_id"]): ?>selected="selected"<?php endif; ?>
                                            >
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($var2["cate_name"]); ?>(<?php echo ($var2["rate"]); ?>‰)</option><?php endif; endforeach; endif; endif; endforeach; endif; ?>
                        </select>
                    ...
                    <td class="rgTdBt">
                        ...
                        <div style="width: 300px;height: 100px; float: left;">
                            <img id="photo_img" width="80" height="80"
                                 src="__ROOT__/attachs/<?php echo (($detail["photo"])?($detail["photo"]):'default.jpg'); ?>"/>
                ...
                <tr>
                    ...
                    <td class="rgTdBt"><input type="text" name="data[attr]" value="<?php echo (($detail["attr"])?($detail["attr"]):''); ?>"
                                              class="manageInput"/>
                ...
                <tr>
                    ...
                    <td class="rgTdBt"><input type="text" name="data[settlement_price]"
                                              value="<?php echo (($detail["settlement_price"])?($detail["settlement_price"]):''); ?>" class="manageInput"/>
                        <code>结算价格必须填写，否则该产品不能设置通过审核。</code>
                    </td>
                </tr>
                <tr>
                    <td class="lfTdBt">可使用积分数：</td>
                    <td class="rgTdBt"><input type="text" name="data[use_integral]"
                                              value="<?php echo (($detail["use_integral"])?($detail["use_integral"]):''); ?>" class="manageInput"/>
                ...
                <tr>
                    ...
                    <td class="rgTdBt"><input type="text" name="data[max_buy]" value="<?php echo (($detail["max_buy"])?($detail["max_buy"]):''); ?>"
                                              class="manageInput"/>
                ...
                <tr>
                    ...
                    <td class="rgTdBt"><input type="text" name="data[rush_kucun]"
                                              value="<?php echo (($detail["rush_kucun"])?($detail["rush_kucun"]):''); ?>" class="manageInput"/>
                ...
                <tr>
                    ...
                    <td class="rgTdBt"><input type="text" name="data[rush_price]"
                                              value="<?php echo (($detail["rush_price"])?($detail["rush_price"]):''); ?>" class="manageInput"/>
                ...
                <tr>
                    ...
                    <td class="rgTdBt"><input type="text" name="data[rush_ltime]"
                                              value="<?php echo (($detail["rush_ltime"])?($detail["rush_ltime"]):''); ?>" onfocus="WdatePicker();"
                                              class="manageInput"/>
                ...
                <tr>
                    ...
                    <td class="rgTdBt">
                        <script type="text/plain" id="data_instructions" name="data[instructions]"
                                style="width:800px;height:360px;"><?php echo ($detail["instructions"]); ?>
                        </script>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="rgTdBt">
                        <script type="text/plain" id="data_details" name="data[details]"
                                style="width:800px;height:360px;"><?php echo ($detail["details"]); ?>
                        </script>
                    </td>
                </tr>
                <script>
