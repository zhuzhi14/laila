...
<div class="content_right">
	<div class="tgdd">
		<div class="tgdd_t password_t">
			<ul>
				<li class="on"><a href="<?php echo U('money/money');?>" >余额充值</a></li>
				<li><a href="<?php echo U('money/recharge');?>" >代金券充值</a></li>
				<li><a href="<?php echo U('money/gold');?>"  >金块充值</a></li>
			</ul>
		</div>
		<form method="post" action="<?php echo U('money/moneypay');?>" >
			<div class="password_nr">
				<div class="password_input">
					...
					<div class="lef">
						<input  class="Confirm" type="text" name="money" />
					</div>
				</div>
				<div class="password_input">
					<div class="left">支付方式</div>
					<div class="lef">
						<?php if(is_array($payment)): foreach($payment as $key=>$var): if(($var["is_open"]) == "1"): if($var['code'] != 'money' and $var['code'] != 'weixin' ): ?><dd>
										<label><em>
											<input class="pay_int" value="<?php echo ($var["code"]); ?>" name="code" type="radio" />
											</em><img src="__PUBLIC__/images/<?php echo ($var["logo"]); ?>" /></label>
