...
function tdwsys_url()
{
//    return "http://192.168.2.126:1092/";
    return "http://58.221.92.138:1092/";
// return  "http://192.168.100.13:1092/";
  //  return "http://192.168.6.15:1092/";
}

function get_stockstype()
{
    return false ;
}
...
function get_wxinfo(){
    ...
    //
    $wx['appid']="wx30b7704828bcc552";
    $wx['secret']='7c7d125d42e17382a252f195905e2ba5';
...
function getAppId() {
    ...
    return "wx1a655b2a22bb0b9c";

}

function getAppSecret() {

    return "2b81a348797ee94d3d7e641a9a91a75b";
...
class JSSDK {
    ...
    public function getSignPackage() {
        ...
        if (isset($_SESSION['phone'])) {
            ...
            $link = "$protocol$_SERVER[HTTP_HOST]/mobile/m.php?phone=$phone";
        }else {

            $link = "$protocol$_SERVER[HTTP_HOST]/mobile/user.php";
        }
