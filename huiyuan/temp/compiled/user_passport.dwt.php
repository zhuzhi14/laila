...
<?php echo $this->smarty_insert_scripts(array('files'=>'common.js,user.js,transport.js,password.js')); ?>
</head>
<body>
      ...
      <table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3">
        <tr>
 		...
 		<tr>
           ...
           <td width="65%"><input type="text" id="smscode" name="smscode" size="20" "><span style="background-color:#ACD6FF;display:-moz-inline-box;display:inline-block; border:1px solid #ccc;font-size:16px;margin-left:10px;border-radius:5px;" onclick="getregsms()"    id="get_code" >获取验证码</span></td>
        </tr>
<!--
        <tr>
...
-->        
         <tr>
          ...
          <td>
          <input name="recode" value="<?php echo $this->_var['recode']; ?>" type="text" size="25" id="recode" onblur="checkRecode(this.value);"  class="inputBg"/>
  ...
  <div class="usBox_2 clearfix">
   <!-- <form action="user.php" method="post">-->
        ...
        <table width="70%" border="0" align="center">
          ...
          <tr>
            <td width="29%" align="right">手机号</td>
            <td width="61%"><input name="user_name" type="text" size="30" id="tel_num" class="inputBg" /></td>
          </tr>
          <tr>
           <td width="29%" align="right">验证码</td>
           <td width="61%"><input type="text" id="smscode" size="25"><button onclick="getsms()"   id="get_code" >获取验证码</button></td>
           </tr>
             <tr>
                       <td width="29%" align="right" bgcolor="#FFFFFF">新密码</td>
                       <td width="61%" ><input  type="password" name="newpwd" id="newpwd"><span id="pass_err"></span></td>
