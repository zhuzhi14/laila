...
$_LANG['label_upvip'] = '购买麦啦订单';
$_LANG['label_upbaodan'] = '升级合伙人';
$_LANG['label_shares'] = '股票回购';
$_LANG['label_in_register'] = '注册新会员';
$_LANG['label_myreg'] = '我注册的会员';
$_LANG['label_myrecom'] = '我推荐的会员';
$_LANG['label_buy_list'] = '购单明细';
$_LANG['label_account_list'] = '电子币明细';
$_LANG['label_accountjf_list'] = '金币明细';
$_LANG['label_fhlist'] = '分红明细';
$_LANG['label_affiliate'] = '我的推荐';
$_LANG['label_afftree'] = '推荐树图';
...
$_LANG['backfee'] = '每周返额';
$_LANG['ordernum'] = '来自订单';
$_LANG['stardate'] = '分红开始区间';
$_LANG['enddate'] = '分红结束区间';
$_LANG['adddate'] = '到账时间';
$_LANG['no_fhlist'] = '暂无分红记录';

/* 我注册的会员/我推荐的 */
$_LANG['myuser_name'] = '用户名';
$_LANG['myuser_realname'] = '姓名';
$_LANG['myrecode'] = '推荐人';
$_LANG['mybaocode'] = '注册人';
$_LANG['myreg_time'] = '注册时间';
$_LANG['myurank'] = '会员等级';
$_LANG['myemail'] = '电子邮件';
$_LANG['no_record'] = '暂无记录';
$_LANG['operates'] = '操作';
$_LANG['buylist'] = '购单明细';
$_LANG['rewardlist'] = '电子币明细';
$_LANG['jinbilist'] = '金币明细';

$_LANG['no_record'] = '暂无记录';
/* 会员余额(预付款) */
$_LANG['add_surplus_log'] = '查看电子币明细';
$_LANG['add_surplusjf_log'] = '查看二个月账单明细';
$_LANG['view_application'] = '查看申请记录';

$_LANG['mybankname'] = '开户银行';
$_LANG['mybankaddress'] = '开户支行名';
$_LANG['myname'] = '开户名';
$_LANG['myaccount'] = '银行卡号';


$_LANG['surplus_pro_type'] = '类型';
$_LANG['repay_money'] = '提现金额';
$_LANG['arrival_money'] = '转电子币';
$_LANG['arrival_goldamt'] = '到账金额';
$_LANG['money'] = '金额';
$_LANG['paypoints'] = '积分';
$_LANG['gold_amt'] = '金币';
$_LANG['surplus_type_0'] = '充值';
$_LANG['surplus_type_1'] = '提现';
$_LANG['surplus_type_2'] = '积分转提';
$_LANG['surplus_type_3'] = '资金转账';
...
$_LANG['current_surplus'] = '当前的可用电子币为：';
$_LANG['current_surplusjf'] = '当前的可用金币为：';
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '赠品免费';
$_LANG['surplus_amount_error'] = '您要申请提现的金额超过了您现有的余额，此操作将不可进行！';
$_LANG['surplus_appl_submit'] = '您的提现申请已成功提交，请等待管理员的审核！';
$_LANG['award_amount_error'] = '您要申请转提的金额超过了您现有的余额，此操作将不可进行！';
$_LANG['award_appl_submit'] = '您的转提申请已成功提交成功！！';
$_LANG['gold_transfer_submit'] = '您的金币转账申请已成功提交成功！！';
...
$_LANG['consume_integral'] = '金币';
$_LANG['account_balance'] = '账户电子币';
...
$_LANG['get_question_username']='请输入你注册是填写的手机号码';
...
/* 会员升级 */
$_LANG['buy_uname'] = '购单会员';
$_LANG['buy_num'] = '购单数量';
$_LANG['buy_type_tips'] = '账户余额与积分都可以用于购买麦啦产品，请选择好购买产品类型，付款后无法更改！';
$_LANG['buy_type_list'] = '一般会员只能自己购买，商务中心可代别人购买。多购不限。';

$_LANG['add_buy_success'] = '购单成功';
$_LANG['buy_list_lnk'] = '返回购单列表';
$_LANG['oper_list_lnk'] = '返回操作界面';
$_LANG['buy_title_empty'] = '购单会员为空';
 $_LANG['buy_uid_empty'] = '购单会员不存在';
 $_LANG['buy_uid_novip'] = '一般会员只能为自己购买，商务中心可代购';
 $_LANG['buy_money_less'] = '资金不足，无法购买';
$_LANG['buy_bordernum'] = '购单编号';
$_LANG['buy_ucode'] = '购单会员';
$_LANG['buy_price'] = '单价';
$_LANG['buy_totalmoney'] = '总额';
$_LANG['buy_fhstart'] = '分红开始';

$_LANG['buy_weekfan'] = '返额';
$_LANG['buy_cycle'] = '周期';
$_LANG['buy_fanzong'] = '总返额';
$_LANG['buy_fanok'] = '已返额';
$_LANG['buy_ifout'] = '状态';
$_LANG['buy_time'] = '购单时间';
$_LANG['buy_paycode'] = '付款会员';

/* 注册新会员 */
$_LANG['add_newmem_success'] = '注册会员成功';
$_LANG['add_newmem_lnk'] = '返回注册新会员';
...
$_LANG['bd_fee'] = '升报单费';
$_LANG['submitbd'] = '立即提交';
$_LANG['app_title_empty'] = '升级会员为空';
 $_LANG['app_uid_empty'] = '升级会员不存在';
 $_LANG['app_uid_novip'] = '只有VIP才能申请报单中心';
 $_LANG['app_money_less'] = '资金不足，无法购买';
 $_LANG['app_uid_exit'] = '已是报单中心，无需再次申请！';
$_LANG['add_app_success'] = '升级报单中心成功';
$_LANG['app_list_lnk'] = '返回报单中心';
...
$_LANG['img_type_tips'] = '<font color="red">小 提 示：</font>';
...
$_LANG['order_is_exchange'] = '[麦啦商城]';
$_LANG['gb_deposit'] = '（保证金）';
$_LANG['notice_gb_order_amount'] = '（备注：团购如果有保证金，第一次只需支付保证金和相应的支付费用）';
$_LANG['business_message'] = '发送/查看商家留言';
$_LANG['pay_order_by_surplus'] = '追加使用电子币支付订单：%s';
$_LANG['return_surplus_on_cancel'] = '取消订单 %s，退回支付订单时使用的电子币';
...
$_LANG['largess'] = '赠品';
//$_LANG['use_more_surplus'] = '追加使用电子币';
//$_LANG['max_surplus'] = '（您的帐户电子币：%s）';
$_LANG['use_more_surplus'] = '追加使用金币';
$_LANG['max_surplus'] = '（您的帐户金币：%s）';
$_LANG['button_submit'] = '确定';
$_LANG['order_detail'] = '订单详情';
$_LANG['error_surplus_invalid'] = '您输入的数字不正确！';
$_LANG['error_order_is_paid'] = '该订单不需要付款！';
$_LANG['error_surplus_not_enough'] = '您的帐户电子币不足！';
...
$_LANG['get_password_by_question'] = '手机找回密码';
//$_lANG['get_password_by_phone']="手机找回密码";
...
$_LANG['recode_empty'] = '推荐人为空';
$_LANG['recode_noexist'] = '推荐人不存在';
...
$_LANG['your_award'] = '积分';
$_LANG['your_level'] = '您的等级是 <font color="green">%s</font> ';
...
$_LANG['passport_js']['username_tellen'] = '- 用户名要为有效的手机号。';
...
$_LANG['passport_js']['recode_empty'] = '- 推荐人 为空';
...
$_LANG['passport_js']['msg_recode_blank'] = '* 请输入推荐人';
$_LANG['passport_js']['msg_recode_registered'] = '* 推荐人不存在,请输入有效的推荐人';
$_LANG['passport_js']['no_select_question'] = '- 您没有完成密码提示问题的操作';
$_LANG['passport_js']['passwd_balnk'] = '- 密码中不能包含空格';

$_LANG['passport_js']['alias_invalid']='-不是一个有效的别名';

$_LANG['passport_js']['idcard_invalid']='*请输入一个有效的身份证号';

$_LANG['passport_js']['sms_empty']='短信验证码不能为空';
$_LANG['passport_js']['sms_error']='短信验证码错误';
/* user_clips.dwt js 语言文件 */
$_LANG['clips_js']['buy_uname_empty'] = '购单会员编号为空';
$_LANG['clips_js']['buy_num_empty'] = '购单会员数量为空';
$_LANG['clips_js']['buynum_amount_error'] = '购单会员数量必须为数字';
...
$_LANG['level_money_all'] = '电子币分成总额百分比';
...
$_LANG['level_money'] = '电子币分成百分比';

$_LANG['affiliate_status'] = '分成状态';

$_LANG['affiliate_point'] = '金币分成';
$_LANG['affiliate_money'] = '电子币分成';
...
$_LANG['buy_order_paym'] = '购单消费电子币';
$_LANG['buy_order_giftp'] = '购单赠送金币';
$_LANG['app_baodan_paym'] = '升级报单消费电子币';
$_LANG['app_baodan_reward'] = '推荐报单中心奖励电子币';
...
$_LANG['to_pay_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城金币';
$_LANG['to_rank_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城等级积分';
$_LANG['from_pay_points'] = '恭喜您， 你%s的商城金币兑换%s论坛%s';
$_LANG['from_rank_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城金币';
...
$_LANG['exchange_points'][1] = '商城金币';
$_LANG['exchange_action'] = '换';
$_LANG['exchange_js']['deny'] = '禁止兑换';
$_LANG['exchange_js']['balance'] = '您的{%s}电子币不足，请重新输入';
...
$_LANG['safe_center']='安全中心';

$_LANG['idcard']='身份证';

$_LANG['passport_js']['user_name_error']="用户名为空"
?>