...
/*
   ...
   if(num==6){
      ...
      goods_total=document.getElementById("goods_total").attributes["val"].value;
       if(document.getElementById("goods_total_shipping")) {
           goods_fee = document.getElementById("goods_total_shipping").attributes["val"].value;
           document.getElementById("goods_total_shipping").innerHTML=goods_fee*3+"金币";
       }
       if(document.getElementById("total_amount")){

           total_amount=document.getElementById("total_amount").attributes["val"].value;
           document.getElementById("total_amount").innerHTML=total_amount*3+"金币";
       }



       document.getElementById("goods_total").innerText=goods_total*3+"金币";
