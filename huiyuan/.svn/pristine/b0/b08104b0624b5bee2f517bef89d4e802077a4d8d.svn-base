    ...
    <h6><span><?php echo $this->_var['lang']['other_info']; ?></span></h6>
      <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            ...
            <tr>
              ...
              <td bgcolor="#ffffff"><input name="integral" type="text" class="input" id="ECS_INTEGRAL" onblur="changeIntegral(this.value)" value="<?php if ($this->_var['your_integral'] > $this->_var['order_max_integral']): ?><?php echo $this->_var['order_max_integral']; ?><?php else: ?><?php echo $this->_var['your_integral']; ?><?php endif; ?>" size="10" />
