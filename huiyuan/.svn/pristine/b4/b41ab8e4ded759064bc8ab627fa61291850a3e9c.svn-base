...
?>
      <h1 onclick="tab(<?php echo ($this->_foreach['no']['iteration'] - 1); ?>)"  <?php if (($this->_foreach['no']['iteration'] <= 1)): ?>style="border-top:none"<?php endif; ?>> <span class="f_l"><img src="themes/ecmoban_yihaodian/images/btn_fold.gif" style="padding-top:10px;padding-right:6px;cursor:pointer;"></span> <a href="javascript:(0);" class="  f_l"><?php echo htmlspecialchars($this->_var['cat']['name']); ?></a> </h1>
