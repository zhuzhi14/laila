...
$modules['08_members']['100_user_buyorder']         = 'user_buyorder.php?act=list';
$modules['08_members']['101_user_fenhong']          = 'user_fenhong.php?act=list';
$modules['08_members']['102_user_baodan']           = 'user_baodan.php?act=list';
*/
