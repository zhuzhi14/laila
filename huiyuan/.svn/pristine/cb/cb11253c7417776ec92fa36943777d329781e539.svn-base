...
class TemplateMessageSDK {
    ...
    public function send_template_message($touser, $template_id, $url, $topcolor, $postdata) {
        $data = array();
        $data['touser'] = $touser;
        ...
        $token_url = "https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=$accessToken";
        $res = http_request($token_url, $data);
...
$templateMsgSDK = new TemplateMessageSDK("","");
?>