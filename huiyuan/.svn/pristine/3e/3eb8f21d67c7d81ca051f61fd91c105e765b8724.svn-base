...
$_LANG['cfg_name']['rewd'] = '购单设置';
$_LANG['cfg_name']['orderfee'] = '订单单价';
$_LANG['cfg_name']['present'] = '赠送积分';
$_LANG['cfg_name']['weekback'] = '每周返额';
$_LANG['cfg_name']['fantotal'] = '总计返额';
$_LANG['cfg_name']['recen'] = '报单奖励';
$_LANG['cfg_name']['appfee'] = '升报单费用';
$_LANG['cfg_name']['jjcen1'] = '第一代奖金';
$_LANG['cfg_name']['jjcen2'] = '第二代奖金';
$_LANG['cfg_name']['jjcen3'] = '第三代奖金';
$_LANG['cfg_name']['gvipnum'] = '报单中心赠送vip所需直推单数';
