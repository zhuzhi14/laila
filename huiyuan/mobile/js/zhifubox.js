...
function  get_pwd_callback(result){
    ...
    if(result=='ok'){
        ...
        var box = "<div  id='bg' style='width:100%;height:200%;position:absolute;top:0px;left:0px;opacity:0.3; filter: alpha(opacity=30); background-color:#000;display: none;z-index:999;'></div><div id='mask' class='mask' style='position: absolute; top:100px;margin-left:50px;  background-color: #fff;z-index: 9999; left: 0px;width:200px ;height:130px;border: 3px solid #2cb7fe;border-radius: 15px;'> <div><span id='mask_close' onclick='hideMask()' style='margin-left:183px;font-size: 16px;color:#2cb7fe'>x</span> </div> <div  style='margin-top:0px'><h2 style='margin-left:20px'>支付密码：</h2><span id='box' style='margin-left:20px;height: 30px;'><input type='password' id='code' maxlength='6'  ></span><div><button  style='margin-top:5px;margin-left:100px' id='check_code' onclick='zhifucode();return false'>提交</button></div></div></div></div>";
